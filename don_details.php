        ...
        <ul class="nav navbar-nav navbar-center">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <a href="" class="dropdown-item"> Add Donor </a>
                    <a href="" class="dropdown-item"> Update Donor </a>
                    <a href="" class="dropdown-item"> Delete Donor </a>
                </div>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown"> Recepient </a>
                <div class="dropdown-menu">
                    <a href="" class="dropdown-item"> Add Recepient </a>
                    <a href="" class="dropdown-item"> Update Recepient </a>
                    <a href="" class="dropdown-item"> Delete Recepient </a>
                </div>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown"> Coordinators </a>
                <div class="dropdown-menu">
                    <a href="" class="dropdown-item"> Add Coordinators </a>
                    <a href="" class="dropdown-item"> Update Coordinators </a>
                    <a href="" class="dropdown-item"> Delete Coordinators </a>
                </div>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown"> Camps </a>
                <div class="dropdown-menu">
                    <a href="" class="dropdown-item"> Add Camp </a>
                    <a href="" class="dropdown-item"> Update Camp </a>
                    <a href="" class="dropdown-item"> Delete Camp </a>
                </div>
            </li>
