    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <form >
                ...
                <input type="text" class="form-control" value="<?php echo $ins_name;?>"disabled>
                </div>
                <div class="form-group">
                <label>Contact Number 1:</label>
                <input type="text" class="form-control" value="<?php echo $contact_1;?>"disabled>
                </div>
                <div class="form-group">
                <label>Contact Number 2:</label>
                <input type="text" class="form-control" value="<?php echo $contact_2;?>"disabled>
                </div>
                <div class="form-group">
                <label>Distance from Sanjeevani:</label>
                <input type="text" class="form-control" value="<?php echo $dis;?>"disabled>
                </div>
            </form>
        </div>
    </div>
